      ...
      <div>
        <div style={containerStyle}>
          ...
          <div className="admin-topicBox colorPrimary-800">
              <div></div>
              <div>
                  <h1 className="center">Dashboard <br></br>ข้อเสนอแนะหลังใช้บริการ "คลินิกกายภาพ"</h1>
              </div>
          ...
          <div className="admin">
            ...
            <div className="admin-header">
                ...
                <a href="/adminDashboardFeedbackAll" target="_parent"  >ข้อเสนอแนะทั่วไป</a>
                    ...
                    <a href="#" target="_parent" id="select">หลังใช้บริการคลินิกกายภาพ</a>
...
export default DashboardFeedbackPhysical;
