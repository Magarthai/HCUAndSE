...
const AppointmentRequestManagementHistoryNeedleComponent = (props) => {
        ...
        try {
            if (user) {
                ...
                const appointmentQuerySnapshot = await getDocs(query(appointmentsCollection,
                    where('appove', 'in', ['ไม่อนุมัติ', 'อนุมัติ']),where('clinic', '==', 'คลินิกฝังเข็ม')));
    ...
    return (
        ...
        <a href="/adminAppointmentRequestManagementComponent"><img src={arrow_icon} className="admin-back-arrow"/></a>
        <div className="admin">
            ...
            <div className="admin-header">
                ...
                <a href="/adminAppointmentRequestManagementComponent" target="_parent" >คลินิกทั้งหมด</a>
                    <a href="/adminAppointmentRequestManagementHistoryPhysicalComponent" target="_parent" >คลินิกกายภาพ</a>
                            <a href="/adminAppointmentRequestManagementHistoryNeedleComponent" target="_parent" id="select">คลินิกฝังเข็ม</a>
                        </div>
            </div>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr className="center colorPrimary-800">
                            <th className="admin-textBody-large colorPrimary-800" id="th_id">รหัสนักศึกษา/รหัสพนักงาน</th>
                                ...
                                <th className="admin-textBody-large colorPrimary-800" id="th_timeOld">เวลาเดิม</th>
                                <th className="admin-textBody-large colorPrimary-800" id="th_timeNew">เวลาใหม่</th>
                    ...
                    {AppointmentUsersData && AppointmentUsersData.length > 0 ? (
                        ...
                        <tr >
                            ...
                            <td className="admin-textBody-huge2 colorPrimary-800">{AppointmentUserData.appointment.appointmentDateOld}</td>
...
export default AppointmentRequestManagementHistoryNeedleComponent;