...
const InformationAdd = (props) => {
    ...
    return (
        ...
        <div className="admin-topicBox colorPrimary-800">
            <div></div>
            <div>
                <h1 className="center">เพิ่มข้อมูลทั่วไป</h1>
            </div>
                        ...
                        <div className="admin-activity-add">
                            <div className="admin-activity-add-hearder-flexbox">
                                ...
                                <div className="admin-timetable-btn" style={{width:"100%"}}>
                                    ...
                                    <input type="submit" value="เพิ่มข้อมูลทั่วไป" className="btn-primary btn-systrm" target="_parent" disabled={informationName === "" || informationDetail == ""}/>
                                </div>
                            </div>
                        </div>
                </form>
